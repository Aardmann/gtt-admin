...
function AnalyticsPage() {
    ...
    const fetchAnalyticsData = async ()=>{
        try {
            ...
            const [usersRes, routesRes, stopsRes, notificationsRes, userGrowthRes] = await Promise.all([
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('created_at').order('created_at')
            ]);
            ...
            setStats({
                ...
                activeUsers: 0,
                // You'd need to calculate this based on last_seen
    ...
    const processUserGrowth = (users)=>{
        ...
        users.forEach((user)=>{
            const date_0 = new Date(user.created_at);
            const monthIndex = last6Months.findIndex((m)=>m.month === date_0.toLocaleDateString('en-US', {
                    month: 'short'
                }));
            if (monthIndex !== -1) {
    ...
    const getRouteStats = async ()=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('routes').select('vehicle_type, approved');
        const stats_0 = data?.reduce((acc, route)=>{
        ...
        return Object.entries(stats_0 || {}).map(([type, data_0])=>({
                type,
                approved: data_0.approved,
                pending: data_0.pending
            }));
    };
    const getNotificationStats = async ()=>{
        const { data: data_1 } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('notifications').select('type, target_type, sent_count, read_count');
        return data_1?.map((n_0)=>({
                type: n_0.type,
                sent: n_0.sent_count,
                read: n_0.read_count,
                rate: n_0.sent_count > 0 ? n_0.read_count / n_0.sent_count * 100 : 0
            })) || [];
    };
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    'Takoradi',
                                    'Cape Coast'
                                ].map((region, index_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center justify-between",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-text",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                ].map((route_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center justify-between p-3 hover:bg-gray-50 rounded",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-medium",
                                                children: route_0.name
                                            }, void 0, false, {
                                                fileName: "[project]/app/dashboard/analytics/page.tsx",
                                                lineNumber: 324,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: route_0.searches.toLocaleString()
                                            }, void 0, false, {
                                                fileName: "[project]/app/dashboard/analytics/page.tsx",
                                                lineNumber: 325,
                                                columnNumber: 17
...
_s(AnalyticsPage, "9DkDizD//T91ung3Y3coinNTrbs=");
_c = AnalyticsPage;
var _c;
