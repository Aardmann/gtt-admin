...
"[project]/components/notifications/NotificationList.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NotificationList(t0) {
    ...
    if ($[0] !== "8f6b4250844b11c393ea58dfbba2f1b8893688f379b3d39ba7344b960eccd2be") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8f6b4250844b11c393ea58dfbba2f1b8893688f379b3d39ba7344b960eccd2be";
    }
    const { notifications, loading, onDelete, onResend } = t0;
    if (loading) {
        let t1;
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    const getTypeBadge = _NotificationListGetTypeBadge;
    const getTargetBadge = _NotificationListGetTargetBadge;
    let t1;
    if ($[3] !== notifications || $[4] !== onDelete || $[5] !== onResend) {
        let t2;
        if ($[7] !== onDelete || $[8] !== onResend) {
            t2 = ({
                "NotificationList[notifications.map()]": (notification)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            notification.target_criteria && Object.keys(notification.target_criteria).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function _NotificationListGetTypeBadge(type) {
    switch(type){
        case "banner":
            {
...
"[project]/components/notifications/NotificationStats.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function NotificationStats(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(30);
    if ($[0] !== "b493f6d6476261665379592eaea183269b7e4c9c9fbeadd808f069cc717b1646") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b493f6d6476261665379592eaea183269b7e4c9c9fbeadd808f069cc717b1646";
    }
    const { stats } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    let t12;
    if ($[17] !== stats.readRate) {
        t12 = stats.readRate.toFixed(1);
        $[17] = stats.readRate;
        $[18] = t12;
    } else {
        t12 = $[18];
...
_c = NotificationStats;
var _c;
__turbopack_context__.k.register(_c, "NotificationStats");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$notifications$2f$NotificationList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/notifications/NotificationList.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$notifications$2f$NotificationStats$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/notifications/NotificationStats.tsx [app-client] (ecmascript)");
...
function NotificationsPage() {
    ...
    const fetchNotifications = async ()=>{
        try {
            setLoading(true);
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('notifications').select('*', {
                count: 'exact'
            });
            if (search) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to load notifications');
        } finally{
            setLoading(false);
        }
    };
    const setupRealtimeSubscription = ()=>{
        const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('notifications-realtime').on('postgres_changes', {
            event: '*',
            schema: 'public',
            table: 'notifications'
    ...
    const handleDeleteNotification = async (notificationId)=>{
        ...
        try {
            const { error: error_2 } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('notifications').delete().eq('id', notificationId);
            if (error_2) throw error_2;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Notification deleted successfully');
        } catch (error_1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to delete notification');
        }
    };
    const handleResendNotification = async (notificationId_0)=>{
        try {
            const { data: notification } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('notifications').select('*').eq('id', notificationId_0).single();
            if (!notification) throw new Error('Notification not found');
            // Re-process notification logic
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Notification resent successfully');
        } catch (error_3) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Failed to resend notification');
        }
    };
    const getStats = ()=>{
        const total = notifications.length;
        const banner = notifications.filter((n)=>n.type === 'banner').length;
        const fullscreen = notifications.filter((n_0)=>n_0.type === 'fullscreen').length;
        const totalSent = notifications.reduce((sum, n_1)=>sum + n_1.sent_count, 0);
        const totalRead = notifications.reduce((sum_0, n_2)=>sum_0 + n_2.read_count, 0);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        value: dateRange,
                                                        onChange: (e_0)=>setDateRange(e_0.target.value),
                                                        className: "px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                value: "all",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$notifications$2f$NotificationList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationList"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-6",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$notifications$2f$NotificationStats$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationStats"], {
                                stats: stats
                            }, void 0, false, {
                                fileName: "[project]/app/dashboard/notifications/page.tsx",
                                lineNumber: 182,
...
_s(NotificationsPage, "5BhZN/GJ6chhqP0h98pn+JPcLiA=");
...
//# sourceMappingURL=_e128f3f2._.js.map