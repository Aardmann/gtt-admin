...
function UsersPage() {
    ...
    const deleteUser = async (userId_0)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').delete().eq('id', userId_0).catch(()=>{}); // Ignore if table doesn't exist or error
    ...
    const filteredUsers = users.filter((user_1)=>{
        ...
        if (filter === 'unverified' && user_1.profile?.role !== 'unverified') return false;
        return true;
    });
    // Pagination
...
//# sourceMappingURL=_9ea02389._.js.map